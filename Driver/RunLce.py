...
disc_nodes = 'lgl' # 'lg', 'lgl', 'nc', 'csbp', 'dg', 'fd', 'upwind'
p = 4
...
#schedule = [['nelem',4,8,16,32,64],['disc_nodes','csbp'],['p',2],['nen',9]]
#dofs, errors, labels = run_convergence(solver,schedule_in=schedule,plot=True,return_conv=True)
