...
def make_dcp_diss_op(sbp_type, s, nen, boundary_fix=True):
    ...
    if sbp_type.lower() == 'csbp' or sbp_type.lower() == 'upwind' or sbp_type.lower() == 'circulant':
        ...
        if s==1:
            ...
            raise Exception('Invalid choice of s. Only coded up s=1,2,3,4,5.')
                ...
                if s==1:
                    ...
                    # Row 1
                    Ds[0, 0] = 1.666666666666667
                    Ds[0, 1] = -3.3333333333333333
                    Ds[0, 2] = 1.666666666666667

                    # Row 2
                    Ds[1, 0] = 1.666666666666667
                    Ds[1, 1] = -3.3333333333333333
                    Ds[1, 2] = 1.666666666666667

                    # Row 3
                    Ds[2, 0] = 1.666666666666667
                    Ds[2, 1] = -3.3333333333333333
                    Ds[2, 2] = 1.666666666666667
                    ...
                    # Row 1
                    Ds[0, 0] = -1.6490089040086547
                    Ds[0, 1] =  4.1767665350122357
                    Ds[0, 2] = -4.1767665350122357
                    Ds[0, 3] = 1.6490089040086547

                    # Row 2
                    Ds[1, 0] = -1.6490089040086547
                    Ds[1, 1] = 4.1767665350122357
                    Ds[1, 2] = -4.1767665350122357
                    Ds[1, 3] = 1.6490089040086547

                    # Row 3
                    Ds[2, 0] = -1.6490089040086547
                    Ds[2, 1] = 4.1767665350122357
                    Ds[2, 2] = -4.1767665350122357
                    Ds[2, 3] = 1.6490089040086547

                    # Row 4
                    Ds[3, 0] = -1.6490089040086547
                    Ds[3, 1] = 4.1767665350122357
                    Ds[3, 2] = -4.1767665350122357
                    Ds[3, 3] = 1.6490089040086547
                    ...
                    # Row 1
                    Ds[0, 0] =  1.7193488544779225
                    Ds[0, 1] = -4.8693488544779225
                    Ds[0, 2] = 6.3
                    Ds[0, 3] = -4.8693488544779225
                    Ds[0, 4] = 1.7193488544779225

                    # Row 2
                    Ds[1, 0] = 1.7193488544779225
                    Ds[1, 1] = -4.8693488544779225
                    Ds[1, 2] = 6.3
                    Ds[1, 3] = -4.8693488544779225
                    Ds[1, 4] = 1.7193488544779225

                    # Row 3
                    Ds[2, 0] = 1.7193488544779225
                    Ds[2, 1] = -4.8693488544779225
                    Ds[2, 2] = 6.3
                    Ds[2, 3] = -4.8693488544779225
                    Ds[2, 4] = 1.7193488544779225

                    # Row 4
                    Ds[3, 0] = 1.7193488544779225
                    Ds[3, 1] = -4.8693488544779225
                    Ds[3, 2] = 6.3
                    Ds[3, 3] = -4.8693488544779225
                    Ds[3, 4] = 1.7193488544779225

                    # Row 5
                    Ds[4, 0] = 1.7193488544779225
                    Ds[4, 1] = -4.8693488544779225
                    Ds[4, 2] = 6.3
                    Ds[4, 3] = -4.8693488544779225
                    Ds[4, 4] = 1.7193488544779225
        ...
        if s==3:
            ...
            h = (nen-1)/(2*1.8022115125776 + nen-5)
            Ds = Ds / h**3
            ...
            h = (nen-1)/(2*2.263895395123 + nen-7)
            Ds = Ds / h**4
            ...
            Ds[0, 0] = -8.209808805241247087
            Ds[0, 1] = 18.024024120655494825
            Ds[0, 2] = -17.692096674770680131
            Ds[0, 3] = 12.181944917154696803
            Ds[0, 4] = -5.392276400865805858
            Ds[0, 5] = 1.088212843067541448

            Ds[1, 0] = -8.209808805241247087
            Ds[1, 1] = 18.024024120655494825
            Ds[1, 2] = -17.692096674770680131
            Ds[1, 3] = 12.181944917154696803
            Ds[1, 4] = -5.392276400865805858
            Ds[1, 5] = 1.088212843067541448

            Ds[2, 0] = -8.209808805241247087
            Ds[2, 1] = 18.024024120655494825
            Ds[2, 2] = -17.692096674770680131
            Ds[2, 3] = 12.181944917154696803
            Ds[2, 4] = -5.392276400865805858
            Ds[2, 5] = 1.088212843067541448

            Ds[3, 0] = -8.209808805241247087
            Ds[3, 1] = 18.024024120655494825
            Ds[3, 2] = -17.692096674770680131
            Ds[3, 3] = 12.181944917154696803
            Ds[3, 4] = -5.392276400865805858
            Ds[3, 5] = 1.088212843067541448
            
            Ds[4, 1] = -1.391324033305301762
            Ds[4, 2] = 5.098357412265064664
            Ds[4, 3] = -8.913925575303230196
            Ds[4, 4] = 8.949251437985736935
            Ds[4, 5] = -4.700301551685318758
            Ds[4, 6] = 0.957942310043049117
            
            Ds[5, 2] = -0.803885959816532824
            Ds[5, 3] = 4.086138692297949853
            Ds[5, 4] = -8.764597439809962133
            Ds[5, 5] = 9.255127895723687792
            Ds[5, 6] = -4.730414564719774936
            Ds[5, 7] = 0.957631376324632248

            Ds[6, 3] = -0.852149123362186611
            Ds[6, 4] = 4.665680161913272424
            Ds[6, 5] = -9.654116593466350890
            Ds[6, 6] = 9.766721490121977124
            Ds[6, 7] = -4.912007389167358537
            Ds[6, 8] = 0.985871453960646490
            ...
            h = (nen-1)/(2*3.3192851303204 + nen-9)
            Ds = Ds / h**5
